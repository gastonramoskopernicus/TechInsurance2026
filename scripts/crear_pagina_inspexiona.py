...
header_path = os.path.join(base_dir, "app/components/Header.tsx")
with open(header_path, "r", encoding="utf-8") as f:
    header_content = f.read()

# Insertar InspeXiona en navItems si no existe
if "InspeXiona" not in header_content:
...
# 2. Generar Logo SVG Placeholder
svg_logo = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 60" width="200" height="60">
  <defs>
  ...
  <g transform="translate(10, 10)">
    <rect x="0" y="0" width="40" height="40" rx="8" fill="none" stroke="url(#magentaGrad)" stroke-width="3" filter="url(#glow)"/>
    <path d="M 10 20 L 30 20 M 20 10 L 20 30" stroke="#fdf4ff" stroke-width="3" stroke-linecap="round"/>
    <circle cx="20" cy="20" r="12" fill="none" stroke="#d946ef" stroke-width="2" stroke-dasharray="4 4" />
  </g>
  <!-- Text -->
  <text x="60" y="38" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif" font-size="28" font-weight="800" fill="#ffffff" letter-spacing="-0.5">
    Inspe<tspan fill="#d946ef">X</tspan>iona
  </text>
</svg>"""

write_file(os.path.join(base_dir, "public/inspexiona-logo.svg"), svg_logo)

# 3. Generar page.tsx
inspexiona_page = """"use client";
...
write_file(os.path.join(base_dir, "app/inspexiona/page.tsx"), inspexiona_page)

# Generar Metadata (layout no es estrictamente necesario, metadata se puede exportar en el page.tsx o crear un layout específico. La agregamos al page)
inspexiona_page_with_meta = inspexiona_page.replace(
    'export default function InspexionaPage() {',
...
write_file(os.path.join(base_dir, "app/inspexiona/page.tsx"), inspexiona_page_with_meta)

print("Página InspeXiona creada exitosamente. Modificado Header.tsx, generado Logo SVG y page.tsx con su metadata.")
