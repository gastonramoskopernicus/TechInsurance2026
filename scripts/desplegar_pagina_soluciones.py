    ...
    <div className="flex flex-col w-full relative bg-[#020104]">
      ...
      <section className="relative pt-32 pb-16 border-b border-white/5 px-4 overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl relative z-10 text-center flex flex-col items-center">
          <div className="relative w-28 h-28 mx-auto mb-10 text-fuchsia-500 animate-breath opacity-90 drop-shadow-[0_0_20px_rgba(217,70,239,0.2)]">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="w-full h-full"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg>
          </div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold tracking-tight text-white mb-6">
            Soluciones diseñadas para <br className="hidden md:block"/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-pink-400">escalar su negocio</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-800 transition-colors">
                 <div className="text-fuchsia-600 mb-4 group-hover:text-fuchsia-400 transition-colors"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-10 h-10"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div>
               ...
               <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-800 transition-colors">
                 <div className="text-fuchsia-600 mb-4 group-hover:text-fuchsia-400 transition-colors"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-10 h-10"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center flex-row-reverse lg:flex-row">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6 order-2 lg:order-1">
               <div className="group p-8 border border-white/5 bg-[#1b081e]/30 rounded-2xl hover:bg-[#1b081e]/80 hover:border-fuchsia-800 transition-colors">
                 <div className="text-zinc-500 mb-4 group-hover:text-fuchsia-400 transition-colors"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-10 h-10"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="9" y1="3" x2="9" y2="21"/></svg></div>
               ...
               <div className="group p-8 border border-white/5 bg-[#1b081e]/30 rounded-2xl hover:bg-[#1b081e]/80 hover:border-fuchsia-800 transition-colors">
                 <div className="text-zinc-500 mb-4 group-hover:text-fuchsia-400 transition-colors"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-10 h-10"><path d="M12 20V10"/><path d="M18 20V4"/><path d="M6 20v-4"/></svg></div>
               ...
               <div className="group p-8 border border-white/5 bg-[#1b081e]/30 rounded-2xl hover:bg-[#1b081e]/80 hover:border-fuchsia-800 transition-colors md:col-span-2">
                 <div className="text-zinc-500 mb-4 group-hover:text-fuchsia-400 transition-colors"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-10 h-10"><circle cx="12" cy="12" r="10"/><path d="M16 16s-1.5-2-4-2-4 2-4 2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg></div>
            ...
            <div className="lg:col-span-5 order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 tracking-tight">
                Para <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-pink-400">Brokers / PAS</span>
              </h2>
      ...
      <section id="bancos" className="py-24 px-4 bg-[#050106] border-b border-white/5 scroll-mt-32 relative">
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5">
              <div className="w-16 h-16 rounded-2xl bg-fuchsia-900/20 border border-fuchsia-800 flex items-center justify-center text-fuchsia-400 mb-8"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-8 h-8"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg></div>
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 tracking-tight">
                Bancos / <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-pink-400">Fintechs</span>
              </h2>
            ...
            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-800 transition-colors md:col-span-2">
                 <div className="text-fuchsia-600 mb-4 group-hover:text-fuchsia-400 transition-colors"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-10 h-10"><line x1="12" y1="2" x2="12" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center flex-row-reverse lg:flex-row">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6 order-2 lg:order-1">
               <div className="group p-8 border border-white/5 bg-[#1b081e]/30 rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-800 transition-colors">
                 <div className="text-zinc-600 mb-4 group-hover:text-fuchsia-400 transition-colors"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-10 h-10"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg></div>
               ...
               <div className="group p-8 border border-white/5 bg-[#1b081e]/30 rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-800 transition-colors">
                 <div className="text-zinc-600 mb-4 group-hover:text-fuchsia-400 transition-colors"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-10 h-10"><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/><path d="M10 17.5h4"/><path d="M17.5 10v4"/></svg></div>
            ...
            <div className="lg:col-span-5 order-1 lg:order-2">
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 tracking-tight">
                Alianzas y <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-pink-400">Partners</span>
              </h2>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5">
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 tracking-tight">
                Embedded <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-pink-400">Insurance</span>
              </h2>
            ...
            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-800 transition-colors">
                 <div className="text-fuchsia-600 mb-4 group-hover:text-fuchsia-400 transition-colors"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-10 h-10"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg></div>
               ...
               <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-800 transition-colors">
                 <div className="text-fuchsia-600 mb-4 group-hover:text-fuchsia-400 transition-colors"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-10 h-10"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center flex-row-reverse lg:flex-row">
            ...
            <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-6 order-2 lg:order-1 relative z-10">
               <div className="group p-8 border border-white/5 bg-[#1b081e]/30 rounded-[2rem] hover:bg-[#16141a] hover:-translate-y-2 hover:border-fuchsia-800 transition-all shadow-[0_10px_30px_rgba(217,70,239,0.02)]">
                 <div className="text-zinc-600 mb-6 group-hover:text-fuchsia-400 transition-colors"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-10 h-10"><path d="M22 17H2a3 3 0 0 0 3-3V9a7 7 0 0 1 14 0v5a3 3 0 0 0 3 3zm-8.27 4a2 2 0 0 1-3.46 0"/></svg></div>
               ...
               <div className="group p-8 border border-white/5 bg-[#1b081e]/30 rounded-[2rem] hover:bg-[#16141a] hover:-translate-y-2 hover:border-fuchsia-800 transition-all shadow-[0_10px_30px_rgba(217,70,239,0.02)]">
                 <div className="text-zinc-600 mb-6 group-hover:text-fuchsia-400 transition-colors"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-10 h-10"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg></div>
            ...
            <div className="lg:col-span-4 order-1 lg:order-2">
              <div className="w-20 h-20 rounded-3xl bg-fuchsia-900/20 border border-fuchsia-800 flex items-center justify-center text-fuchsia-400 mb-8"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-10 h-10"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg></div>
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 tracking-tight">
                Canales Digitales <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-pink-400">CX</span>
              </h2>
