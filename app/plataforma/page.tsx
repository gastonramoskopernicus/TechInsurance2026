    ...
    <div className="flex flex-col w-full relative bg-[#020104]">
        ...
        <div className="container mx-auto max-w-5xl relative z-10 text-center flex flex-col items-center">
          ...
          <div className="border border-fuchsia-500/20 rounded-3xl p-10 lg:p-14 bg-black/50 backdrop-blur-md shadow-2xl text-left max-w-4xl mx-auto">
            ...
            <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
               ...
               {/* Card 2 */}
               <div className="group p-8 rounded-2xl border border-fuchsia-900/30 bg-[#0f0e11] hover:bg-[#16141a] hover:border-fuchsia-500/40 hover:shadow-[0_10px_40px_rgba(217,70,239,0.05)] transition-all text-left">
                 <div className="text-fuchsia-600 group-hover:text-fuchsia-400 mb-6 transition-colors"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><rect x="2" y="2" width="20" height="20" rx="2"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg></div>
               ...
               {/* Card 3 */}
               <div className="group p-8 rounded-2xl border border-fuchsia-900/30 bg-[#0f0e11] hover:bg-[#16141a] hover:border-fuchsia-500/40 hover:shadow-[0_10px_40px_rgba(217,70,239,0.05)] transition-all text-left">
                 <div className="text-fuchsia-600 group-hover:text-fuchsia-400 mb-6 transition-colors"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg></div>
      ...
      <div className="sticky top-20 z-40 w-full flex justify-center px-4 pointer-events-none mt-8 mb-4">
        <nav className="pointer-events-auto flex items-center space-x-1 overflow-x-auto p-2 bg-gradient-to-r from-[#200e23]/90 via-[#0f0e11]/90 to-black/90 backdrop-blur-xl border border-fuchsia-900/20 rounded-full shadow-[0_10px_40px_rgba(217,70,239,0.1)] hide-scrollbar">
          {[
            { id: 'capacidades', label: 'Capacidades', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-4 h-4"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg> },
            { id: 'product-studio', label: 'Product Studio', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-4 h-4"><path d="m18 16 4-4-4-4"/><path d="m6 8-4 4 4 4"/><path d="m14.5 4-5 16"/></svg> },
            { id: 'modulos', label: 'Módulos', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-4 h-4"><rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/></svg> },
            { id: 'arquitectura', label: 'Arquitectura', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-4 h-4"><path d="M3 21h18"/><path d="M9 8h1"/><path d="M9 12h1"/><path d="M9 16h1"/><path d="M14 8h1"/><path d="M14 12h1"/><path d="M14 16h1"/><path d="M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16"/></svg> },
            { id: 'orquestacion', label: 'Orquestación', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-4 h-4"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg> },
            { id: 'api-developer', label: 'API Platform', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-4 h-4"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg> },
            { id: 'seguridad', label: 'Seguridad', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-4 h-4"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/></svg> },
            { id: 'licenciamiento', label: 'Licenciamiento', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-4 h-4"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg> },
          ].map((item) => (
            <a 
              key={item.id} 
      ...
      <section className="py-24 px-4 border-b border-white/5 bg-[#050106] pt-28 -mt-20">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold mb-10 text-white tracking-tight">
            El Concepto de <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-pink-400">Urbanización</span>
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div className="p-10 rounded-2xl bg-[#0f0e11] border border-fuchsia-950 shadow-lg relative overflow-hidden h-full flex flex-col justify-center">
              ...
              <div className="grid grid-cols-1 gap-4 mb-10 relative z-10">
                 <div className="flex gap-4 items-center p-4 bg-[#0f0e11] hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 rounded-xl border border-white/5">
                   <div className="text-fuchsia-500"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5"><polyline points="20 6 9 17 4 12"/></svg></div>
      ...
      <section id="capacidades" className="py-24 px-4 border-b border-white/5 bg-[#020104] pt-32 -mt-16 scroll-mt-32">
        <div className="container mx-auto max-w-6xl">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-white tracking-tight">
            Capacidades <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-pink-400">Centrales</span>
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
             <div className="group relative rounded-2xl bg-[#0f0e11] border border-fuchsia-900/30 p-8 hover:border-fuchsia-500/40 hover:bg-[#200e23] transition-all duration-500 flex flex-col overflow-hidden h-full">
                <div className="mb-6 text-zinc-500 group-hover:text-fuchsia-400 transition-colors duration-500"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><path d="M12 2l8 4.6v9.2L12 20.4l-8-4.6V6.6z"/><path d="M12 2v20"/><path d="M12 11.2l-8-4.6"/><path d="M12 11.2l8-4.6"/></svg></div>
             ...
             <div className="group relative rounded-2xl bg-[#0f0e11] border border-fuchsia-900/30 p-8 hover:border-fuchsia-500/40 hover:bg-[#200e23] transition-all duration-500 flex flex-col overflow-hidden h-full">
                <div className="mb-6 text-zinc-500 group-hover:text-fuchsia-400 transition-colors duration-500"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><circle cx="12" cy="12" r="9"/><path d="M12 3v9"/><path d="M12 12l4.24 4.24"/></svg></div>
             ...
             <div className="group relative rounded-2xl bg-[#0f0e11] border border-fuchsia-900/30 p-8 hover:border-fuchsia-500/40 hover:bg-[#200e23] transition-all duration-500 flex flex-col overflow-hidden h-full lg:col-span-2">
                <div className="mb-6 text-zinc-500 group-hover:text-fuchsia-400 transition-colors duration-500"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><path d="M16 21v-2a4 4 0 0 0-4-4H5c-1.1 0-2 .9-2 2v2"/><circle cx="8.5" cy="7" r="4"/><polyline points="17 11 19 13 23 9"/></svg></div>
      ...
      <section id="product-studio" className="py-24 border-b border-border/50 relative overflow-hidden bg-[#0d040e] scroll-mt-32">
        ...
        <div className="container mx-auto px-4 lg:px-8 text-center max-w-4xl relative z-10">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white tracking-tight">
            Product Studio: <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-pink-400">Autonomía Comercial</span>
          </h2>
          ...
          <a href="/product-studio" className="inline-flex h-14 items-center justify-center rounded-xl bg-fuchsia-600 px-8 text-base font-bold text-white shadow-[0_0_30px_rgba(192,38,211,0.3)] hover:shadow-[0_0_40px_rgba(192,38,211,0.5)] hover:bg-fuchsia-500 transition-all gap-3 group">
             ...
             <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-5 h-5 group-hover:translate-x-1 transition-transform"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
          </a>
        </div>
      </section>
      ...
      <section id="modulos" className="py-32 px-4 bg-[#020104] border-b border-white/5 scroll-mt-32 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-24">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white tracking-tight">
              Módulos <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-pink-400">Core</span>
            </h2>
          ...
          <div className="space-y-32">
            ...
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-8 border-b border-white/5 pb-4 flex items-center">
                <span className="text-zinc-600 mr-4 font-light text-xl">01</span> Product & Core <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-pink-400 ml-2">Layer</span>
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                   <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><path d="M12 2l8 4.6v9.2L12 20.4l-8-4.6V6.6z"/><path d="M12 2v20"/><path d="M12 11.2l-8-4.6"/><path d="M12 11.2l8-4.6"/></svg></div>
                ...
                <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                   <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><circle cx="12" cy="12" r="10"/><path d="M12 8v8"/><path d="M8 12h8"/></svg></div>
                ...
                <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                   <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg></div>
                ...
                <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                   <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg></div>
            ...
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-8 border-b border-white/5 pb-4 flex items-center">
                <span className="text-zinc-600 mr-4 font-light text-xl">02</span> Commercial <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-pink-400 ml-2">Layer</span>
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                 <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                   <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><path d="M16 21v-2a4 4 0 0 0-4-4H5c-1.1 0-2 .9-2 2v2"/><circle cx="8.5" cy="7" r="4"/><polyline points="17 11 19 13 23 9"/></svg></div>
                ...
                <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                   <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg></div>
                ...
                <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                   <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg></div>
                ...
                <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                   <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><path d="M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20z"/><path d="M12 8v4l3 3"/></svg></div>
                ...
                <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                   <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="9" y1="3" x2="9" y2="21"/></svg></div>
                ...
                <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                   <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg></div>
            ...
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-8 border-b border-white/5 pb-4 flex items-center">
                <span className="text-zinc-600 mr-4 font-light text-xl">03</span> Experience <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-pink-400 ml-2">Layer</span>
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                   <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg></div>
                ...
                <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                   <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><path d="M22 17H2a3 3 0 0 0 3-3V9a7 7 0 0 1 14 0v5a3 3 0 0 0 3 3zm-8.27 4a2 2 0 0 1-3.46 0"/></svg></div>
            ...
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-8 border-b border-white/5 pb-4 flex items-center">
                <span className="text-zinc-600 mr-4 font-light text-xl">04</span> Integration <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-pink-400 ml-2">Layer</span>
              </h3>
            ...
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-8 border-b border-white/5 pb-4 flex items-center">
                <span className="text-zinc-600 mr-4 font-light text-xl">05</span> Data & <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-pink-400 ml-2">Intelligence</span>
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="mt-20">
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-8 border-b border-white/5 pb-4 flex items-center">
                <span className="text-zinc-600 mr-4 font-light text-xl">06</span> GRC <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-pink-400 ml-2">Layer</span>
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                 
                 <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                    <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><path d="M17 21v-2a4 4 0 0 0-4-4H5c-1.1 0-2 .9-2 2v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div>
                 ...
                 <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                    <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></div>
                 ...
                 <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                    <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><polyline points="11 8 11 11 14 14"/></svg></div>
                 ...
                 <div className="group p-8 border border-white/5 bg-[#0f0e11] rounded-2xl hover:bg-[#16141a] hover:border-fuchsia-900/50 transition-all duration-300 flex flex-col">
                    <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-500 transition-colors duration-300"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></svg></div>
            ...
            <div className="mt-20">
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-8 border-b border-white/5 pb-4 flex items-center">
                <span className="text-zinc-600 mr-4 font-light text-xl">07</span> Payments <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-pink-400 ml-2">Layer</span>
              </h3>
      ...
      <section id="arquitectura" className="py-24 px-4 bg-[#050106] border-b border-white/5 scroll-mt-32 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white tracking-tight">
            Arquitectura <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-pink-400">Desacoplada</span>
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            <div className="group p-8 border border-white/5 rounded-2xl bg-[#0f0e11] hover:border-fuchsia-800 hover:bg-[#16141a] transition-all duration-300">
               <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-400 transition-colors duration-300 flex justify-center"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg></div>
            ...
            <div className="group p-8 border border-white/5 rounded-2xl bg-[#0f0e11] hover:border-fuchsia-800 hover:bg-[#16141a] transition-all duration-300">
               <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-400 transition-colors duration-300 flex justify-center"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg></div>
            ...
            <div className="group p-8 border border-white/5 rounded-2xl bg-[#0f0e11] hover:border-fuchsia-800 hover:bg-[#16141a] transition-all duration-300">
               <div className="mb-6 text-zinc-600 group-hover:text-fuchsia-400 transition-colors duration-300 flex justify-center"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-12 h-12"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg></div>
